...
```
`--lanes todo,implement,verify,review,integrate,done,blocked` on `board init` shows the stages as
lanes; see [usage.md](usage.md#the-journal-flight-plan--board--resume).
