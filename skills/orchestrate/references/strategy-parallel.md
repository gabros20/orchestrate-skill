...
guessing; one whose input is another card's output should not be *running* before it lands —
launch it gated (`board launch … --after N`: the wrapper waits, the model never pays to wait)
